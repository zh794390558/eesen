...
echo $pyver
wait
export PYTHONPATH=$PYTHONPATH:`pwd`/tools/g2p/lib64/python${pyver}/site-packages
if [ ! -f tools/g2p/lib64/python${pyver}/site-packages/g2p.py ]; then
...
#python2 tools/g2p/lib/python${pyver}/site-packages/g2p.py \
python2 `which g2p.py` \
